    ...
    public class Store {
        ...
        void Reset() {
            ...
            Equipment.SetState(
                ...
                (SlotType.BodyArmor.ToString(), CreateItem(Bases.LeatherArmor, Rarity.Unique)),
                (SlotType.Gloves.ToString(), CreateItem(Bases.LeatherGloves, Rarity.Magic)),
                (SlotType.Boots.ToString(), CreateItem(Bases.SteelBoots, Rarity.Magic)),
                (SlotType.Weapon.ToString(), CreateItem(Bases.ShortSword, Rarity.Rare))
            );
